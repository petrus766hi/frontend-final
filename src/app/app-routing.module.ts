...
const routes: Routes = [
  ...
  Shell.childRoutes([{ path: 'profile_update', loadChildren: () => import('./profile_update/profile_update.module').then((m) => m.Profile_UpdateModule) }]),
  ...
  Shell.childRoutes([{ path: 'change_pwd', loadChildren: () => import('./change_pwd/change_pwd.module').then((m) => m.Change_PwdModule) }]),
  Shell.childRoutes([{ path: 'password', loadChildren: () => import('./password/password.module').then((m) => m.PasswordModule) }]),
  Shell.childRoutes([{ path: 'reset_password/:id', loadChildren: () => import('./reset_password/reset_password.module').then((m) => m.Reset_PasswordModule) }]),
